...
export const metadata: Metadata = {
  title: 'Terms',
  description: 'Terms of use for the Sea Link Electrical and Software Pvt. Ltd website.',
}
  ...
  return (
    <main className="thank-you-main">
      <div className="container thank-you-panel card">
        ...
        <p>
          This website is provided by Sea Link Electrical and Software Pvt. Ltd for informational
        ...
        <p>
          All content is © Sea Link Electrical and Software Pvt. Ltd. For questions, contact{' '}
